...
const MapView: React.FC<MapViewProps> = ({
  ...
  const focusOnServiceLocation = (service: SubService) => {
    ...
    // setTimeout(() => {
    //     const allMarkers = mapInstanceRef.current._layers;
    //     Object.values(allMarkers).forEach((layer: any) => {
    //         if (layer.getLatLng &&
  ...
  const handleServiceSelect = (service: SubService) => {
    ...
    focusOnServiceLocation(service);
  };
  ...
  useEffect(() => {
    ...
    L.marker([userLocation.lat, userLocation.lng], { icon: userIcon })
      .addTo(map)
      .bindPopup(
        "<div class='p-2'><strong class='text-blue-600'>📍 Your Location</strong></div>"
      );
              ...
              {loading ? (
                <div className="flex flex-col items-center justify-center h-96">
                  ...
                  <p className="text-gray-600 font-medium">
                    Loading your location and services...
                  </p>
